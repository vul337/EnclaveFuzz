...
extern "C"
{
    ...
    sgx_status_t SGX_CDECL sgxsan_ocall_addr2line(uint64_t *addr_arr, size_t arr_cnt, int level = 0);
    ...
    sgx_status_t SGX_CDECL sgxsan_ocall_get_mmap_infos(void **mmap_infos, size_t *real_cnt);
#if defined(__cplusplus)
}
#endif